...
volatile bool flag = false; // Definição de um flag
int alok[3] = {0,0,0}; // Definição do vetor de alocagem
char akg = "Fim"; // Definição de um aknologe
...
// Função de retorno do número do grupo
int grupo(String seq) {
  // Verificação de qual grupo pertence a mensagem
  if (seq == "A+{A-//B+}A+{B-//A-}"){
    return 1; // Retorna o valor
  }
  else if (seq == "A-{A+//B+}A-{B-//A+}"){
    return 2; // Retorna o valor
  }
  else if (seq == "A+{A-//B-}A+{B+//A-}"){
    return 3; // Retorna o valor
  }
  else if (seq == "A-{A+//B-}A-{B+//A+}"){
    return 4; // Retorna o valor
  }
  else if (seq == "A+{A-//B+}{A+//B-}A-"){
    return 5; // Retorna o valor
  }
  else if (seq == "A-{A+//B+}{A-//B-}A+"){
    return 6; // Retorna o valor
  }
  else if (seq == "A+{A-//B-}{A+//B+}A-"){
    return 7; // Retorna o valor
  }
  else if (seq == "A-{A+//B-}{A-//B+}A+"){
    return 8; // Retorna o valor
  }
  else {
